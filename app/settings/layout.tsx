...
export default function SettingsLayout({ children }: SettingsLayoutProps) {
  ...
  return (
    <SidebarProvider defaultOpen={true}>
            ...
            <div className="flex items-center gap-1 sm:gap-2">
              {mounted && (
                <Button
                  ...
                  className="text-purple-600 dark:text-purple-300 hover:text-purple-700 dark:hover:text-purple-200 hover:bg-purple-200 dark:hover:bg-dark-bg-tertiary p-2"
                >
      ...
      <SidebarInset className="flex flex-col !bg-transparent h-screen overflow-hidden bg-purple-50 dark:bg-dark-bg">
        <SettingsHeader />
